...
from SIR_trial import SIR_modelling
...
import os
print(os.getcwd())
df_analyse = pd.read_csv('C:/Users/VIPUL/Desktop/Enterprise Data Science/ads_covid-19/data/processed/COVID_final_set.csv', sep = ';')
